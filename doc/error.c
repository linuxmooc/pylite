...
void location_dump(location_t *this)
{
    fprintf(stderr, "  At %s.py, line %d, in %s()\n", 
            this->file_name, this->line_number, this->lambda_name);
}
...
{
    py_exception = py_class_new("Exception");
    py_exception->py_alloc = py_error_alloc;
